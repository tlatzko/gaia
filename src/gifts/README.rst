==================================================================
gaia: One-line description of the package
==================================================================
...
When the package is installed via ``easy_install`` or ``pip`` this function will be bound to the ``gifts`` executable in the Python installation's ``bin`` directory (on Windows - the ``Scripts`` directory).
